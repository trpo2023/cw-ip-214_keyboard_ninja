...
!(function (t, e) {
  ...
  function zn(t, e, i, s) {
    ...
    let h, c, d, u;
    for (h = i, c = i + s; h < c; ++h)
      (u = e[h]), (d = {}), (d[n.axis] = r || n.parse(a[h], h)), l.push(In(u, d, o, h));
    return l;
  }
  function Fn(t) {
  ...
  function Vn(t, e, i, s) {
    ...
    "middle" === n &&
      ...
      (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[Bn(c, a, r, l)] = !0), (n = h))),
      (o[Bn(n, a, r, l)] = !0),
      (t.borderSkipped = o);
  }
  function Bn(t, e, i, s) {
  ...
  var $n = Object.freeze({
    ...
    BarController: class extends Ws {
      ...
      parseObjectData(t, e, i, s) {
        ...
        let d, u, f, g;
        for (d = i, u = i + s; d < u; ++d)
          (g = e[d]), (f = {}), (f[n.axis] = n.parse(M(g, l), d)), c.push(In(M(g, h), f, o, d));
        return c;
      }
      updateRangeFromParsed(t, e, i, s) {
    ...
    eo && !e.options.segment
      ...
      : (function (t, e, i, s) {
          const { segments: n, options: o } = e,
            a = to(e);
          for (const r of n)
            Kn(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke();
        })(t, e, i, s);
  }
  class so extends Hs {
    static id = "line";
    ...
    buildTicks() {
      ...
      const n = (function (t, e) {
        ...
        for (
          b &&
          (u && M !== a
            ? (i.push({ value: a }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, po(a, y, t)) && D++)
            : M < a && D++);
          D < k;
          ++D
        ) {
  ...
  function zo(t, e) {
    ...
    return (
      ...
      null === l
        ? null
        : (o && (l = "week" !== o || (!W(r) && !0 !== r) ? i.startOf(l, o) : i.startOf(l, "isoWeek", r)), +l)
    );
  }
  function Fo(t, e, i, s) {
    const n = Ro.length;
